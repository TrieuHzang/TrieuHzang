...
- Graduation Project: Developing a Raspberry Pi-based baby sleep safety monitoring system using embedded Linux, computer vision, and audio processing.

**My current focus:** `C/C++ Firmware` - `STM32 / ESP32` - `Raspberry Pi` - `Embedded Linux` - `IoT` - `Edge AI`
